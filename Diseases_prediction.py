...
#insert image
    ...
    with open("C:/Users/Ritik/3D Objects/Health Guard System/Saved_models/a.jpg","rb") as f:
        data=f.read()
        st.image(data)
...
# Insert image  
    with open("C:/Users/Ritik/3D Objects/Health Guard System/Saved_models/b.jpg","rb") as f:
        data=f.read()
        st.image(data)      
...
# Insert image    
    with open("C:/Users/Ritik/3D Objects/Health Guard System/Saved_models/cancer.jpg","rb") as f:
        data=f.read()
        st.image(data)
...
# Insert image    
    with open("C:/Users/Ritik/3D Objects/Health Guard System/Saved_models/liver.jpg","rb") as f:
        data=f.read()
        st.image(data)
...
# Insert image    
    with open("C:/Users/Ritik/3D Objects/Health Guard System/Saved_models/parkinsons.jpg","rb") as f:
        data=f.read()
        st.image(data)
